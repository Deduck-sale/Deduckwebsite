...
/**
 * Single homepage layout shared by both / (Thai) and /en (English).
 * Locale is resolved by LanguageProvider based on the URL, so the
 * components themselves are language-agnostic.
 */
